...
export type actionTypes = {
    type: projectsActionTypes.ADD_PROJECTS | projectsActionTypes.REMOVE_PROJECTS | projectsActionTypes.REMOVE_PROJECT_TITLE | projectsActionTypes.DEL_ROJECT_TITLE | projectsActionTypes.ADD_PROCESS | projectsActionTypes.REMOVE_PROCESS_TITLE | projectsActionTypes.DELETE_PROCESSES,
