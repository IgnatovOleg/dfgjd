...
const defaultState: Iusers = {
    users: [
        { id: 1, login: "ignatovoleg", password: "ignatovOleg!", confirmPassword: "ignatovOleg!", firstName: "Oleg", lastName: "Ignatov", middleName: "Volodomorovich", email: "08623.ignatovoleg@gmail.com", phone: "380934352419", authorization: false },
